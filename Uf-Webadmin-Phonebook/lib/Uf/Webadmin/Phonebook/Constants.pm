...
Uf::Webadmin::Phonebook::Constants - Application constants
...
our $TEMPLATE_PEOPLE_HOME = File::Spec->join($DIRECTORY_PEOPLE, $TEMPLATE_HOME);
...
our $TEMPLATE_UNITS_HOME = File::Spec->join($DIRECTORY_UNITS, $TEMPLATE_HOME);
