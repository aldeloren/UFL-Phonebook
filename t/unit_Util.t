...
is_deeply([ UFL::Phonebook::Util::tokenize_query('tokens, two') ], [ qw/tokens two/ ], 'two tokens with comma and space');
is_deeply([ UFL::Phonebook::Util::tokenize_query('tokens,two') ], [ qw/tokens two/ ], 'two tokens with comma');
is_deeply([ UFL::Phonebook::Util::tokenize_query('tokeNS,Two') ], [ qw/tokens two/ ], 'two tokens with comma and case normalization');
...
is_deeply([ UFL::Phonebook::Util::tokenize_query('tokens, thr ee') ], [ qw/tokens thr ee/ ], 'three tokens with comma and space');
is_deeply([ UFL::Phonebook::Util::tokenize_query('tokens,thr ee') ], [ qw/tokens thr ee/ ], 'three tokens with comma');
is_deeply([ UFL::Phonebook::Util::tokenize_query('tOKens,THr eE') ], [ qw/tokens thr ee/ ], 'three tokens with comma and case normalization');
