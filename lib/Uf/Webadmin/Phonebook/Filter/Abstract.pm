package Uf::Webadmin::Phonebook::Filter::Abstract;

use strict;
use Uf::Webadmin::Phonebook::Filter::Abstract::Operator;
use Uf::Webadmin::Phonebook::Filter::Abstract::Predicate;
...
sub new {
    ...
    my $root = Uf::Webadmin::Phonebook::Filter::Abstract::Operator->new($_[0]);
    my $self = {
        root => $root,
    };
...
Add an operator or predicate to this LDAP filter.
  ...
  # Create an operator
  my $filter2 = Uf::Webadmin::Phonebook::Filter::Abstract->new('!');
...
sub _node {
    ...
    if (scalar @_ == 1 and blessed $_[0] and $_[0]->isa(__PACKAGE__)) {
        ...
        # Predicate
        $node = Uf::Webadmin::Phonebook::Filter::Abstract::Predicate->new(@_);
    }
    else {
