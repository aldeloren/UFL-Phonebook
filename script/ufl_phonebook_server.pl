...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{UFL_PHONEBOOK_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{UFL_PHONEBOOK_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
ufl_phonebook_server.pl - Catalyst Testserver

=head1 SYNOPSIS

ufl_phonebook_server.pl [options]
